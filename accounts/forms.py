...
from .models import Profile, Course, CustomUser, Badge, Certificate
...
class StudentUpdateForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ['student_photo', 'phone_number', 'gender', 'date_of_birth' ,'address','grade_year_level','course','department']
        widgets = {
            'student_photo': forms.ClearableFileInput(attrs={'class': 'form-control'}),
            'gender': forms.Select(attrs={'class': 'form-control'}),
            'address': forms.Textarea(attrs={'class': 'form-control'}),
...
class BadgeForm(forms.ModelForm):
    class Meta:
        model = Badge
        fields = ['profiles','name', 'image', 'description']
        widgets = {
            'profiles': forms.SelectMultiple(attrs={'class': 'form-control'}),
            'name': forms.TextInput(attrs={'class': 'form-control'}),
