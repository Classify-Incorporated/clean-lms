...
class ActivityForm(forms.ModelForm):
    ...
    class Meta:
        model = Activity
        fields = ['activity_name', 'activity_type', 'subject', 'term', 'module', 'start_time', 'end_time', 'show_score', 'remedial', 'remedial_students', 'time_duration', 'max_retake', 'retake_method','passing_score', 'passing_score_type', 'activity_instruction']
        widgets = {
