...
urlpatterns = [
    ...
    path('activities_per_subject/', activities_per_subject, name='activities_per_subject'),
    ...
    path('edit_activity_question/<int:activity_id>/<int:question_id>/', edit_activity_question, name='edit_activity_question'),

    path('list_questions/<int:activity_id>/', list_activity_questions, name='list_activity_questions'),
    path('delete_activity_question/<int:activity_id>/<int:question_id>/', delete_activity_question, name='delete_activity_question'),
    ...
    path('activity/<int:activity_id>/edit-participation/', EditParticipationView.as_view(), name='edit_participation'),
