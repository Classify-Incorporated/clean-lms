...
#         'NAME': 'sncfi',  # Replace with your database name
#         'USER': 'sncfi',      # Replace with your username
#         'PASSWORD': 'Sncfi12#',  # Replace with your password
#         'HOST': 'localhost',   # Set to the IP address or hostname if using a remote server
#         'PORT': '5432',        # Default PostgreSQL port
#     }
# }
...
# DATABASES = {
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',fkjdsfjsdkfdsfsdhoweewj
#         'NAME': 'classedgegsu',  # Replace with your database name
#         'USER': 'classedgegsu',      # Replace with your username
#         'PASSWORD': '!Surallah12#',  # Replace with your password
#         'HOST': 'localhost',   # Set to the IP address or hostname if using a remote server
#         'PORT': '5432',        # Default PostgreSQL port
#     }
# }
...
#     'default': {
#         'ENGINE': 'django.db.backends.postgresql',
#         'NAME': 'newhope',  # Replace with your database name
#         'USER': 'newhope',      # Replace with your username
#         'PASSWORD': 'Manila123',  # Replace with your password
#         'HOST': 'localhost',   # Set to the IP address or hostname if using a remote server
#         'PORT': '5432',        # Default PostgreSQL port
#     }
# }
...
# Replace Microsoft with Google OAuth
