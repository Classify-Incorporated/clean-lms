from .models import MessageUnreadStatus, Notification, FriendRequest
...
def unread_messages_count(request):
    ...
    unread_count = MessageUnreadStatus.objects.filter(user=request.user).count()
...
def unread_notifications_count(request):
    ...
    # Convert friend requests to a notification-like format
    friend_notifications_list = [{
        "id": friend.id,
        "message": f"{friend.sender.get_full_name()} sent you a friend request.",
        "created_at": friend.created_at,
        "icon": "fas fa-user-friends",
        "type": "friend_request",
        "is_read": False  # Always unread
