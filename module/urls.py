...
urlpatterns = [
    ...
    path('semester_date_range/', get_semester_dates, name='semester_date_range'),
    path('teacher_progress_report/', teacher_progress_report, name='teacher_progress_report'),
    path('gale_library/', gale_library, name='gale_library'),
]